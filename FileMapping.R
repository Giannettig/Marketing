...
skl_stats <- read_csv("/data/in/tables/out.c-sklik.stats.csv")
...
# sek.nextval AS "id"
# FROM "fba_ads_insights" AS a
# LEFT JOIN "fba_ads" AS b 
# ON a."ad_id"=b."id"
# LEFT JOIN "fba_adsets" AS c 
# ON b."adset_id"=c."id"
# LEFT JOIN "fba_campaigns" AS e 
# ON c."campaign_id"=e."id"
# LEFT JOIN "fba_accounts" AS f
...
save.image("/data/out/files/MarketingLibrary.RDA")